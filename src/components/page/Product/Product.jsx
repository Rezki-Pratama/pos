    ...
    return (
        <div>
            ...
            <div className="py-8">
                ...
                <div className="flex flex-row items-center rounded-xl text-white text-sm font-bold px-4 py-3" role="alert" style={{"display" : message.display,"backgroundColor": message.bgColor}}>
                    <div className="flex">
